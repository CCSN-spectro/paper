...
For each of the noise realizations, we reconstruct the ratio time series {$r_i$}
...
Figure \ref{fig:aLIGO_cov_allwvf} shows that apart from {\texttt s11} and to a lesser extent
