...
\begin{figure}[t]
  ...
  \caption{Median of the relative error $\Delta$ as a function of the  distance to the source for the CCSN waveform model {\texttt s20S} embedded in third-generation detector noise. \pcd{[PCD: Should we show the corresponding blue ranges for the pure noise case?]}\mab{MAB: We would need to show 5 noise ranges. I haven't tried what it looks like. Could give a try}}
