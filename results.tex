...
\begin{figure}[t]
  ...
  \caption{Maximal distance at which the ratio $r=M_{\rm PNS}/R_{\rm PNS}^2$ is reconstructed
    with good accuracy for all GW detectors analyzed in this study. The values are shown for all eight CCSN waveforms of our sample assuming that the source is optimally oriented with respect to the detector. \tf{I guess that for CE2 s15G is overlapping with s25. Should we mention this in the caption? Use AdV instead of ADV?}} 
\label{fig:distances}
\end{figure}
