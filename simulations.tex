...
\maob{%%
  We apply our analysis to spherically symmetric
  \citep{Torres:2019} and two-dimensional axisymmetric models of
...
\maob{%%
  ...
  $M_{\mathrm{ZAMS}} = 11.2 - 75 \, \Msol$ simulated with the two
  codes.  They were carried out using six equations of state (EOSs).
  They are complemented by a set of 7 two-dimensional axisymmetric
  models consisting of stellar core collapse of five stars with
  zero-age main-sequence masses of
  $M_{\mathrm{ZAMS}} = 11.2 - 40 \, \Msol$ evolved through the
  hydrostatic phases by
