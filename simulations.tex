...
\pcd{Unlike the model set, the simulations in the test set cannot be 1D becase we need to extract the gravitational wave signal, which is
...
(GShen) for the {progenitor} with $M_{\mathrm{ZAMS}} = 15 \, \Msol$. To this set of
