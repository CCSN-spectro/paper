...
To avoid any systematic effect, we only use to build our model the $18$ simulations performed with the ALCAR-AENUS
...
To \pcd{\sout{develop}  describe} the method we \pcd{\sout{considered} focus on} the gravitational wave signal
\pcd{of} {\texttt s20S}, originally
