...
\mab{Alphabetical order ? Better to move forward the youngest}
...
\begin{abstract}
  ...
  whose frequency time evolution is linked to the radius and the mass of the proton neutron star through
  universal relations demonstrated in ~\cite{Torres:2019b}. We have developed a simple algorithm to extract
  from the gravitational wave data the frequency evolution of the gravity mode. We have used a set of 1D
  core collapse supernova simulations to build a model of evolution of the proto neutron star properties
  ...
  11 and 40 solar mass and different equation of state. We have shown that for Advanced LIGO and Advanced
  Virgo detectors at design sensitivity it will be possible to infer poroton neutron star properties for
